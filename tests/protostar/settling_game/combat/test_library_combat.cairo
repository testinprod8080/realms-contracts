...
@external
func test_build_boss_squad{range_check_ptr}() {
    alloc_locals;

    let (empty) = build_empty_troop();
    let (zombie_king) = build_troop(TroopId.ZombieKing);

    let (s) = Combat.build_boss_squad(TroopId.ZombieKing);
    assert_troop_eq(s.t1_1, empty);
    assert_troop_eq(s.t1_2, empty);
    assert_troop_eq(s.t1_3, empty);
    assert_troop_eq(s.t1_4, empty);
    assert_troop_eq(s.t1_5, empty);
    assert_troop_eq(s.t1_6, empty);
    assert_troop_eq(s.t1_7, empty);
    assert_troop_eq(s.t1_8, empty);
    assert_troop_eq(s.t1_9, empty);
    assert_troop_eq(s.t2_1, empty);
    assert_troop_eq(s.t2_2, empty);
    ...
    assert_troop_eq(s.t2_4, empty);
    assert_troop_eq(s.t2_5, empty);
    assert_troop_eq(s.t3_1, zombie_king);
